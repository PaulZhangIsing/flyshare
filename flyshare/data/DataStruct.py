...
class DataStruct_Index_day(__stock_hq_base):
    ...
    def __init__(self, DataFrame):
        ...
        self.type = 'index_day'
        self.if_fq = ''
        self.mongo_coll = Setting.client.quantaxis.index_day
...
class DataStruct_Index_min(__stock_hq_base):
    ...
    def __init__(self, DataFrame):
        ...
        self.mongo_coll = Setting.client.quantaxis.index_min
...
class DataStruct_Stock_min(__stock_hq_base):
    def __init__(self, DataFrame):
        ...
        self.type = 'stock_min'
        self.if_fq = 'bfq'
        self.mongo_coll = Setting.client.quantaxis.stock_min
...
class DataStruct_Stock_day(__stock_hq_base):
    def __init__(self, DataFrame):
        ...
        self.type = 'stock_day'
        self.if_fq = 'bfq'
        self.mongo_coll = Setting.client.quantaxis.stock_day
...
class DataStruct_Stock_transaction():
    def __init__(self, DataFrame):
        ...
        self.if_fq = 'None'
        self.mongo_coll = Setting.client.quantaxis.stock_transaction
